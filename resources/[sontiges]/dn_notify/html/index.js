...
function creatednNotification(title, message, options, pDuration) {
...
function dnNotify(title, text, type, duration) {
  creatednNotification(title, text, dnNotifications[type], duration)
}
