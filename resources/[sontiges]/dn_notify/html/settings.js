...
function initSettings() {
  userSettings = JSON.parse(localStorage.getItem('dnNotifySettings'))

  if (userSettings == null) {
    localStorage.setItem('dnNotifySettings', JSON.stringify(defaultSettings))
...
function saveSettings(settings) {
  localStorage.setItem('dnNotifySettings', JSON.stringify(settings))
  $.post(
    'http://dn_notify/action',
    JSON.stringify({
      action: 'close',
    })
  )
